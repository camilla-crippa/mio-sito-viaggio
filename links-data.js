...
const linksData = {
  ...
  2: {
    hotelGmaps: "https://maps.google.com/?q=Hotel+Ziggy+on+Sunset",
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Valet parking dell'hotel </li> <li> Beverly Hills & Santa Monica</li> </ul>",
    parkingGmaps: [
  ...
  3: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Hollywood Public Parking </li> <li> Route 66: parcheggi gratuiti lungo strada in tutte le cittadine</li> <li> Parcheggio hotel gratuito</li> </ul>",
    parkingGmaps: [
      { name: "Hollywood Public Parking", url: "https://maps.google.com/?q=6801+Hollywood+Blvd+Los+Angeles+CA+90028" }
    ],
    parkingCost: "Hollywood Public Parking a pagamento",
  ...
  4: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Route 66: parcheggi gratuiti lungo strada in tutte le cittadine</li> <li> Parcheggio hotel gratuito</li> </ul>",
    parkingCost: "Gratis",
  ...
  6: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Parcheggio Horseshoe Bend</li> <li> Parcheggio hotel gratuito</li> </ul>",
    parkingCost: "$10/veicolo (Horseshoe Bend)",
  ...
  9: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Parcheggio hotel a pagamento</li> </ul>",
  ...
  12: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Parcheggio Red Rock Canyon State Park</li> <li> Parcheggio hotel gratuito</li> </ul>",
    parkingCost: "$6/veicolo (Red Rock Canyon) + Gratis (hotel)",
