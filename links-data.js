...
const linksData = {
  ...
  3: {
    ...
    parking: "<ul style='padding-left: 20px; margin: 8px 0;'><li>Hollywood & Highland Parking ($3 prime 2h) </li> <li> Route 66: parcheggi gratuiti lungo strada in tutte le cittadine</li> <li> Parcheggio hotel gratuito</li> </ul>",
    parkingGmaps: [
